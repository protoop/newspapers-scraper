...
class Scrapper:
    ...
    def __init__(self):
        self.name = '20 Minutes'
        self.homepage_url = "http://www.20minutes.fr"
        self.watched_urls = []
    ...
    def start_scrapping_articles_found_on_homepage(self):
        ...
        # Articles
        articles = soup.select("article .teaser-title a")
    ...
    def get_article_infos_and_log_into_DB(self,url):
        ...
        article_themes = [link.text for link in soup_article.select(".breadcrumb a") if 'Accueil' != link.text]
